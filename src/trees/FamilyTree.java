...
public class FamilyTree
{
	...
	public FamilyTree() throws IOException, TreeException
	{
		...
		FileReader fr = new FileReader("/Users/chelseavu/Downloads/BagginsFamilyTree.txt");
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0)
			throw new TreeException("Error, no colon found");
		...
		for (String curr: childrenArray) {
			TreeNode childNode = new TreeNode(curr);
